 ...
 *       &lt;sequence>
 *         &lt;element name="Info" type="{http://www.bangkokbank.com/schema/entity/CoreLib/2011/01/15}NameValueType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InfosType {
    ...
    protected List<NameValueType> info;
     ...
     * 
     */
    public List<NameValueType> getInfo() {
        if (info == null) {
            info = new ArrayList<NameValueType>();
        }
        return this.info;
    }
