 ...
 *       &lt;sequence>
 *         &lt;element name="Owner" type="{http://www.bangkokbank.com/schema/entity/Customer/2011/01/15}CustomerInfoRefType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class OwnersType {
    ...
    protected List<CustomerInfoRefType> owner;
     ...
     * 
     */
    public List<CustomerInfoRefType> getOwner() {
        if (owner == null) {
            owner = new ArrayList<CustomerInfoRefType>();
        }
        return this.owner;
    }
